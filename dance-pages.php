...
<form action="dance-pages.php" method="post">
    <section class="agenda">
        ...
        $result = $danceContr->dancePagesGetAllContr();
        ?>
        <section class="container">
            ...
            $paragraph3 = '';
            if (isset($_GET['edit'])){
                $row = $danceContr->dancePagesGetEditDataContr();
                $id = $row['page_id'];
                $name = $row['name'];
                $title = $row['title'];
            ...
            <section class="main" style="margin-top: 0; width: 80%;">
                ...
                <?php
                if ($update == true): ?>
                    <button type="submit" style="margin-left: 40%; margin-bottom: 10px; padding-bottom: 5px" class="submit" name="dance-update-page">Update</button>
                <?php else: ?>
                    <button type="submit" style="margin-left: 41%; margin-bottom: 10px; padding-bottom: 5px" class="submit" name="dance-save-page">Save</button>
                <?php endif;?>
</form>
</section>
</form>
