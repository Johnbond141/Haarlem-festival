        ...
        <section class="container">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="functions-jazz.php" method="post" style="display: inline">
                                    ...
                                    <button class="btn btn-danger btn-sm" name="jazz-delete" type="submit">Delete
                                    </button>
                                </form>
                            </td>
                        </tr>
            ...
            <section class="main" style="margin-top: 0; width: 80%;">
                ...
                <section style="display: inline-block; width: 45%; margin-left: 2.5%;">
                    <input type="text" name="band" align="center" class="un" value="<?php echo $band; ?>"
                           placeholder="band...">
                    <input type="text" name="location" align="center" class="un" value="<?php echo $location; ?>"
                           placeholder="location...">
                    <input type="text" name="hall" align="center" class="un" value="<?php echo $hall; ?>"
                           placeholder="hall...">
                    <input type="text" name="date" align="center" class="un" value="<?php echo $date; ?>"
                           placeholder="date...">
                </section>
                <section style="display: inline-block; width: 45%;">
                    <input type="text" name="day" align="center" class="un" value="<?php echo $day ?>"
                           placeholder="day...">
                    <input type="text" name="time" align="center" class="un" value="<?php echo $time ?>"
                           placeholder="time...">
                    <input type="text" name="seats" align="center" class="un" value="<?php echo $seats ?>"
                           placeholder="seats...">
                    <input type="text" name="price" align="center" class="un" value="<?php echo $price ?>"
                           placeholder="price...">
                </section>
                <?php
                if ($update == true): ?>
                    <button type="submit" style="margin-left: 40%; margin-bottom: 10px; padding-bottom: 5px"
                            class="submit" name="jazz-update">Update
                    </button>
                <?php else: ?>
                    <button type="submit" style="margin-left: 41%; margin-bottom: 10px; padding-bottom: 5px"
                            class="submit" name="jazz-save">Save
                    </button>
                <?php endif; ?>
                </form>
            </section>
